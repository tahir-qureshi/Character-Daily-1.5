...
//    private Schedule schedule;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLesson.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(FeedBackActivity.this, ImageDownloading.class));
                finish();
            }
        });
        btnMore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(FeedBackActivity.this, MoreOptionsActivity.class));
                finish();
            }
        });
                ...
                fbdatabaseReference.push().setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            startActivity(new Intent(FeedBackActivity.this, MoreOptionsActivity.class));
                            finish();
                            Toast.makeText(FeedBackActivity.this, "Recorded Inserted Success", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(FeedBackActivity.this, "Recorded Not inserted", Toast.LENGTH_LONG).show();
                        }
                    }
                });
    ...
    public void onBackPressed() {
        Intent backMainTest = new Intent(this, DailyLessonActivity.class);

    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLesson.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(AppFeedBackActivity.this, ImageDownloading.class));
                finish();
            }
        });
        btnMore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AppFeedBackActivity.this, MoreOptionsActivity.class));
                finish();
            }
        });
        ...
        tvclander.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AppFeedBackActivity.this, MainActivity.class));
                finish();
            }
        });
                ...
                fbdatabaseReference.push().setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            startActivity(new Intent(AppFeedBackActivity.this, MoreOptionsActivity.class));
                            finish();
                            Toast.makeText(AppFeedBackActivity.this, "Recorded Inserted Success", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(AppFeedBackActivity.this, "Recorded Not inserted", Toast.LENGTH_LONG).show();
                        }
                    }
                });

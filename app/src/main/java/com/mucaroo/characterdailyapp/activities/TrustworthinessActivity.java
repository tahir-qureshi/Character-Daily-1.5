...
public class TrustworthinessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trustworthiness);
        ...
        txt_title.setText("TRUSTWORTHINESS    ");

        textView = (TextView) findViewById(R.id.tvTrust);
        ...
        trdatabaseReference = FirebaseDatabase.getInstance().getReference().child("evergreen").child("pillars");

        trdatabaseReference.addChildEventListener(new ChildEventListener() {
            @Override

...
public class QuoteSubmissionActivity extends AppCompatActivity {
                ...
                fbdatabaseReference.push().setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            startActivity(new Intent(QuoteSubmissionActivity.this, DailyQuoteActivity.class));
                            ShowDialog();
                            finish();
                            Toast.makeText(QuoteSubmissionActivity.this, "Recorded Inserted Success", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(QuoteSubmissionActivity.this, "Recorded Not inserted", Toast.LENGTH_LONG).show();
                        }
                    }
                });
            }
...
//        txt_all_grades.setText(grades);
    ...
    public void ShowDialog() {
        final Dialog dialog = new Dialog(QuoteSubmissionActivity.this);
        dialog.setContentView(R.layout.custom_login_dialogbox);
        TextView txttitle = (TextView) findViewById(R.id.tvpoptitle);

...
public class DailyQuoteActivity extends AppCompatActivity implements ActionSheetProfile.ActionSheetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        body =  MainActivity.Qbody;//  getIntent().getStringExtra("Body");
...
//        txt_title.setText("DAILY QUOTE");
        ...
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(DailyQuoteActivity.this);
...
//        getSupportActionBar().setCustomView(R.layout.activity_action_bar);
        ...
        DB.getInstance(DailyQuoteActivity.this).getScheduleLessonQuote(Globals.ClientID, Integer.parseInt(pillarid), day, Gradedata, new DBCallback<ScheduleLessonQuote>() {
            @Override
            public void success(final ScheduleLessonQuote o) {
//                final String lessonID = o.lesson;
                final String quoteID = o.quote;
                statusRef = FirebaseDatabase.getInstance().getReference().child("users").child(userId).child("Chalanges").child(currentdate).child(Gradedata).child(quoteID);
...
//                                }
        ...
        txt_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(DailyQuoteActivity.this, MainActivity.class));
                finish();
            }
        });
        ...
        btn_more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DailyQuoteActivity.this, MoreOptionsActivity.class));
                finish();
            }
        });
        ...
        btn_all.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DailyQuoteActivity.this, ImageDownloading.class));
                finish();
            }
        });
                ...
                DB.getInstance(DailyQuoteActivity.this).getScheduleLessonQuote(Globals.ClientID, Integer.parseInt(pillarid), day, Gradedata, new DBCallback<ScheduleLessonQuote>() {
                    ...
                    public void success(final ScheduleLessonQuote o) {
                        ...
                        if (circle.equals("false")) {
                            ...
                            databaseReference.child("users").child(userId).child("Chalanges").child(currentdate).child(Gradedata).child(quoteID).child("Quote").setValue("true").addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
...
//                }
                            ...
                            circle = "false";
                            imageViewCircle.setImageResource(R.mipmap.empty_circle);
                            databaseReference.child("users").child(userId).child("Chalanges").child(currentdate).child(Gradedata).child(quoteID).child("Quote").setValue("false").addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
//                            Toast.makeText(DailyQuoteActivity.this, "Quote Score Submit flase", Toast.LENGTH_LONG).show();
                                }
...
//            Toast.makeText(getApplicationContext(), "Lesson Submission is Selected", Toast.LENGTH_LONG).show();
            startActivity(new Intent(this, QuoteSubmissionActivity.class));
            finish();
        }

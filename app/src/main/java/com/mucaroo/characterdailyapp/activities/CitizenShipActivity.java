...
public class CitizenShipActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_citizen_ship);
        ...
        final TextView textView = (TextView) findViewById(R.id.tvCitizenship);

        cdatabaseReference = FirebaseDatabase.getInstance().getReference().child("evergreen").child("pillars");

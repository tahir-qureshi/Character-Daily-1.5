 ...
 */
public class ActionSheetPillars extends Fragment implements OnClickListener {
    ...
    private ActionSheetListenerPillars mListener;
    private View mView;
    ...
    private View createView() {
        ...
        mBg.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,
                LayoutParams.MATCH_PARENT));
        mBg.setBackgroundColor(Color.argb(200, 50, 50, 50));
        mBg.setId(BG_VIEW_ID);
        mBg.setOnClickListener(this);

        mScrol = new ScrollView(getActivity());
        ...
        horizontalScrollView.addView(mPanel);
        mScrol.addView(horizontalScrollView);
//        parent.addView(mBg);
//        parent.addView(mPanel);
    ...
    private void createItems() {
        ...
        if (titles != null) {
            for (int i = 0; i < titles.length; i++) {
                ...
                textView.setBackgroundDrawable(getOtherButtonBg(titles, i));
                textView.setText(titles[i]);
                textView.setTextColor(mAttrs.otherButtonTextColor);
                textView.setTextSize(mAttrs.actionSheetTextSize);
        ...
        //her is buttom
        params.bottomMargin = mAttrs.getCancelButtonMarginBottom;
    ...
    public void onDestroyView() {
        ...
        if (mListener != null) {
//            mListener.onDismissGrades(this, isCancel);
            mListener.onDismissPillars(this, isCancel);
        }
...
//        }
    ...
    public void setActionSheetListener(ActionSheetListenerPillars listener) {
        mListener = listener;
    }
    ...
    public void onClick(View v) {
        ...
        if (v.getId() != CANCEL_BUTTON_ID && v.getId() != BG_VIEW_ID) {
            if (mListener != null) {
//                mListener.onOtherButtonClickGrades(this, v.getId() - CANCEL_BUTTON_ID
//                        - 1);
                mListener.onOtherButtonClickPillars(this, v.getId() - CANCEL_BUTTON_ID
                        - 1);
            }
            isCancel = false;
        }
    ...
    private static class Attributes {
        ...
        int getCancelButtonMarginBottom = 15;
    ...
    public static class Builder {
        ...
        public Builder setListener(ActionSheetListenerPillars listener) {
        ...
        public ActionSheetPillars show() {
            ActionSheetPillars actionSheet = (ActionSheetPillars) Fragment.instantiate(
                    mContext, ActionSheetPillars.class.getName(), prepareArguments());
    ...
    public static interface ActionSheetListenerPillars {

//        void onDismissGrades(ActionSheetPillars actionSheet, boolean isCancel);
//
//        void onOtherButtonClickGrades(ActionSheetPillars actionSheet, int index);

        void onDismissPillars(ActionSheetPillars actionSheet, boolean isCancelPillar);

        void onOtherButtonClickPillars(ActionSheetPillars actionSheet, int indexPillar);
    }

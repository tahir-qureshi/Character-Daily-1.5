...
public class MoreOptionMyLessonSubMissionActivity extends AppCompatActivity implements ActionSheetProfile.ActionSheetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(MoreOptionMyLessonSubMissionActivity.this);
...
//        txt_title.setText("SUBMIT A LESSON");
        ...
        txtCross.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MoreOptionMyLessonSubMissionActivity.this, MoreOptionsActivity.class));
                finish();
            }
        });
                ...
                mlsdatabaseReference.push().setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            startActivity(new Intent(MoreOptionMyLessonSubMissionActivity.this, MoreOptionsActivity.class));
                            finish();
                            Toast.makeText(MoreOptionMyLessonSubMissionActivity.this, "Recorded Inserted Success", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(MoreOptionMyLessonSubMissionActivity.this, "Recorded Not inserted", Toast.LENGTH_LONG).show();
                        }
                    }
                });
...
//                                finish();
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(MoreOptionMyLessonSubMissionActivity.this, "Please Select The JPG Image", Toast.LENGTH_LONG).show();
                        }
                    });

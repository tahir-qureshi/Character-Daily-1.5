...
public class TeamActivity extends AppCompatActivity {
    ...
    private DatabaseReference tdatabaseReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView textView = (TextView) findViewById(R.id.tvTeam);

        tdatabaseReference = FirebaseDatabase.getInstance().getReference().child("evergreen").child("clients").child("default").child("0");

        tdatabaseReference.addChildEventListener(new ChildEventListener() {
            @Override

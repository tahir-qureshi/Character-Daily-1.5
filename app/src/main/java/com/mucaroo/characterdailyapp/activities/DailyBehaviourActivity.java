...
public class DailyBehaviourActivity extends AppCompatActivity implements ActionSheetProfile.ActionSheetListener {
...
//        txt_title.setText("DAILY BEHAVIOUR");
        ...
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(DailyBehaviourActivity.this);
...
//                    }
        ...
        DB.getInstance(DailyBehaviourActivity.this).getBehaviour(Globals.ClientID, Integer.parseInt(pillarID), Gradedata, new DBCallback<String>() {
            @Override
...
//                        Log.i("", result);
        ...
        txt_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(DailyBehaviourActivity.this, MainActivity.class));
                finish();
            }
        });
        ...
        btn_more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DailyBehaviourActivity.this, MoreOptionsActivity.class));
                finish();
            }
        });
        ...
        btn_all.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DailyBehaviourActivity.this, ImageDownloading.class));
                finish();
            }
        });
...
//                    String date = String.valueOf(System.currentTimeMillis()/1000L);
                    databaseReference.child("users").child(userId).child("Chalanges").child(currentdate).child(Gradedata).child("behavior").setValue("true").addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
...
//                    });
                    ...
                    circle = "false";
                    imageViewCircle.setImageResource(R.mipmap.empty_circle);
                    databaseReference.child("users").child(userId).child("Chalanges").child(currentdate).child(Gradedata).child("behavior").setValue("false").addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {

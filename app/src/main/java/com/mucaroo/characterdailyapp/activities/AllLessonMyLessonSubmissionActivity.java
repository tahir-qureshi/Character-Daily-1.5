...
public class AllLessonMyLessonSubmissionActivity extends AppCompatActivity implements ActionSheetProfile.ActionSheetListener  {

    String[] profileData = {"Photos", "Camera"};
    private Uri mCapturedImageURI;
    private EditText etTitle, etBody, etAuthor, grade, pillar;
    private DatabaseReference mlsdatabaseReference;
    String Gradedata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(AllLessonMyLessonSubmissionActivity.this);
...
//        txt_title.setText("SUBMIT A LESSON");
        ...
        txtCross.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AllLessonMyLessonSubmissionActivity.this, AllLessonDailyLessonActivity.class));
                finish();
            }
        });
                ...
                mlsdatabaseReference.push().setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            startActivity(new Intent(AllLessonMyLessonSubmissionActivity.this, AllLessonDailyLessonActivity.class));
                            finish();
                            Toast.makeText(AllLessonMyLessonSubmissionActivity.this, "Recorded Inserted Success", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(AllLessonMyLessonSubmissionActivity.this, "Recorded Not inserted", Toast.LENGTH_LONG).show();
                        }
                    }
                });

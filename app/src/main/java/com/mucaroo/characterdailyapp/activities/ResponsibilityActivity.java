...
public class ResponsibilityActivity extends AppCompatActivity {
    ...
    private DatabaseReference rpdatabaseReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_title.setText("RESPOSIBILITY     ");
        ...
        final TextView textView = (TextView) findViewById(R.id.tvResponsibility);

        rpdatabaseReference = FirebaseDatabase.getInstance().getReference().child("evergreen").child("pillars");

        rpdatabaseReference.addChildEventListener(new ChildEventListener() {
            @Override
